...
def regression(x,y):
    ...
    for i in range(0,11):
        ...
        print ("on i %d , valid set mean error %f, training set error: %f, test set error: %f, percentage of nonzeros in w %f"%(i*10, errorvalidtest/10, errortrainingset/10, errortestset, wnonzerototal/wtotal))
